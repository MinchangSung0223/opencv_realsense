...
def read_point_cloud(pcd_file, point_multiplier=1.0):
    ...
    cloud = o3d.io.read_point_cloud(pcd_file,remove_nan_points=True,remove_infinite_points=True)
    print(cloud)
    if cloud.is_empty():
        return False, None
...
if __name__ == '__main__':
    ...
    for i, id in enumerate(file_ids):
        ...
        img, cloud_points = extract_image_and_points(pcd, 960, 1280)
    ...
    o3d.visualization.draw_geometries([pcd, mesh_frame_est])
